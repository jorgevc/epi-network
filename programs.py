...
# def comparison_SimpleControl_NoControl_Model_SIR():
# 	#numero de simulaciones en el ensemble
...
# def comparison_SimpleControl_NoControl_SameNetwork_Model_SIR():
# 	#numero de simulaciones en el ensemble
# 	number_of_simulations = 100
...
# 		x[1]=0
# 		sim.set_initial_conditions_all_patches(x) # se agregan las condiciones iniciales para todos las zonas
# 		x[1]=1. # Se agrega 1 infectado a las condiciones iniciales
# 		sim.set_initial_conditions_patch(1,x) #Se establece esta condicion inicial en la zona 1
# 		sim.set_model(SIRControl) #Se establece el modelo usado en PLOS como modelo para hacer la simulacion
# 		P=MobilityNetwork() #Se crea la red de mobilidad
# 		P.binomial(n,p,min_residential) #para cada simulacion se genera una nueva red binomial
...
if (__name__ == '__main__'):
	...
	#comparison_SimpleControl_NoControl_Model_SIR()
	#comparison_SimpleControl_NoControl_SameNetwork_Model_SIR()